...
public class blue_opencvSkystoneDetector extends LinearOpMode {
    ...
    public static float[] midPos = {5f/8f+offsetX, 4f/8f+offsetY};//0 = col, 1 = row
    public static float[] leftPos = {3f/8f+offsetX, 4f/8f+offsetY};
    public static float[] rightPos = {7f/8f+offsetX, 4f/8f+offsetY};
